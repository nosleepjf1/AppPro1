...
$sqlStatement2 = "SELECT * FROM form_data WHERE form_id = $formId AND submission_id = $submissions[0]";
...
$sqlStatement3 = "SELECT * FROM form_image WHERE form_id = $formId AND submission_id = $submissions[0]";
